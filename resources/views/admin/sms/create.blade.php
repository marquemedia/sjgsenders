                    ...
                    <div class="note-container col-xl-3 order-xl-2 order-1 d-xl-block d-none">
                        <div class="note">
                            ...
                            <div class="note-body">
                                ...
                                <p class="d-none select-sms-android-gateway-note note-message">{{translate("This option allows you to select a specific android gateway's sim. Which will be used to send this SMS. If none are selected then the automatic system will choose a random sim from any available gateway and send the message from it")}}</p>
                            </div>
                        </div>
                    </div>
                </div>
